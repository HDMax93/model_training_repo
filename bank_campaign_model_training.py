...
bucket = storage_client.bucket("udemy-mlops")
...
def write_metrics_to_bigquery(algo_name, training_time, model_metrics):
    ...
    table_id = "udemy-mlops-411816.ml_ops.bank_campaign_model_metrics"
...
def main():
    input_data_path = "gs://udemy-mlops/Section4-ContinuousTraining-Airflow-Composer/bank-campaign-training-data.csv"
    model_name = 'xgboost'
